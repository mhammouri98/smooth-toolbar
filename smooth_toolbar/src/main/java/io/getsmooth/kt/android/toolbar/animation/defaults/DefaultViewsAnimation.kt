...
import io.getsmooth.kt.android.toolbar.animation.ViewsAnimation

class DefaultViewsAnimation : ViewsAnimation {

    override fun getViewsAnimation(oldViews: List<View>?, newViews: List<View>): Animator? = null
